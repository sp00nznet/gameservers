#!/bin/bash
#
# Counter-Strike 1.6 Dedicated Server Setup (Docker)
# Builds and runs a CS 1.6 server in a Docker container
#
...
readonly CONTAINER_NAME="csserver"
readonly IMAGE_NAME="gameservers/cs16"
readonly STEAM_APP_ID="90"
readonly INSTALL_DIR="/home/steam/csserver"
...
RUN mkdir -p /home/steam/csserver && chown -R steam:steam /home/steam/csserver
...
RUN /home/steam/steamcmd/steamcmd.sh \
    ...
    +login anonymous \
    +app_update 90 +app_set_config 90 mod cstrike validate \
    +quit
...
setup_data_directory() {
    ...
    DATA_DIR=$(create_game_data_dir "cs16")
    mkdir -p "${DATA_DIR}/cstrike"

    local server_cfg="${DATA_DIR}/cstrike/server.cfg"
...
run_container() {
    ...
    local volume_mappings="-v ${DATA_DIR}/cstrike:${INSTALL_DIR}/cstrike"
